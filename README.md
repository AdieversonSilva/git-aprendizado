...
| Trabalhando com Branches - Comando Úteis no dia a dia | ``` git diff <branch> origin/<branch>``` | Verifica as diferenças entre as branches |
...
| Extra | ``` git commit -a -m <Commit> ``` | Adicionar e commitar repositório |
